        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'} >
          <Box bg='white' w='40%' p={0} align={'center'} borderRadius='lg'>
            ...
            <Stack spacing={4} w={'full'} maxW={'md'} color={'black'} bg='white' p={6} borderRadius='lg'>
              ...
              <Stack align={'center'}>
                <FormControl >
                  <Input mb={1} id="netIdPwReset" borderColor={'#330662'} maxW='200px' type="text"  placeholder='NetID' color={'#330662'} _placeholder={{ color: '#330662' }} borderWidth={'2px'} />
                </FormControl>
              </Stack>
  
              <Stack spacing={6} align={'center'}>                
                  <Button borderRadius='md' bg='#330662' color='white' px={20} fontSize={20} maxW='300px' h='45px' _hover={{ bg:'#7b5aa6'}}>
